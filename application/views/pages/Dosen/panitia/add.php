            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('dosen/penunjang/panitia/store') ?>" novalidate="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="nama">Nama Kegiatan<sup class="text-danger">*</sup></label>
                                    <input id="nama" type="text" class="form-control" name="nama" tabindex="1" placeholder="Masukkan Nama Kegiatan" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" id="id_status" name="id_status">
                                        ...
                                        <?php
                                        foreach ($status as $d) : ?>
                                            <option value=<?= $d->id ?>> <?= $d->kepanitiaan ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="penyelenggara" type="text" class="form-control" name="penyelenggara" tabindex="1" placeholder="Masukkan Penyelenggara Kegiatan" required>
                                    <div class="invalid-feedback">
