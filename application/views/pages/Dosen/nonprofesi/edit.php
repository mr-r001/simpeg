            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($nonprofesi as $data) : ?>
                                <form method="post" class="needs-validation" action="<?php echo site_url('dosen/penunjang/nonprofesi/update') ?>" novalidate="" enctype="multipart/form-data">
