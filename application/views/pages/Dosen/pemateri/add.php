            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('dosen/tridharma/pemateri/store') ?>" novalidate="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="judul">Judul Kegiatan<sup class="text-danger">*</sup></label>
                                    <input id="judul" type="text" class="form-control" name="judul" tabindex="1" placeholder="Masukkan Judul Kegiatan" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="penyelenggara" type="text" class="form-control" name="penyelenggara" tabindex="1" placeholder="Masukkan Penyelenggara" required>
                                    <div class="invalid-feedback">
