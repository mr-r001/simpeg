            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($haki as $data) : ?>
                                <form method="post" class="needs-validation" action="<?php echo site_url('dosen/tridharma/haki/update') ?>" novalidate="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" id="id_kategori" name="id_kategori">
                                            <option value="" selected disabled>-- Pilih Kateogori HAKi --</option>
                                            <?php
