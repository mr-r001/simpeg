                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($pengabdian as $data) : ?>
                                <form method="post" class="needs-validation" action="<?php echo site_url('dosen/tridharma/pengabdian/update') ?>" novalidate="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" id="id_status" name="id_status">
                                            ...
                                            <?php
                                            foreach ($status as $d) : ?>
                                                <option <?php if ($data->id_status == $d->id) : echo 'selected'; ?><?php endif; ?> value=<?= $d->id ?>> <?= $d->team ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
