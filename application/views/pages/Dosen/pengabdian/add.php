            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('dosen/tridharma/pengabdian/store') ?>" novalidate="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="judul">Judul/Nama Kegiatan Pengabdian<sup class="text-danger">*</sup></label>
                                    <input id="judul" type="text" class="form-control" name="judul" tabindex="1" placeholder="Masukkan Judul/Nama Kegiatan Pengabdian" required>
                                    <div class="invalid-feedback">
                                        Masukkan Judul/Nama Kegiatan Pengabdian terlebih dahulu
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Status dalam Tim<sup class="text-danger">*</sup></label>
                                    <select class="form-control selectric" id="id_status" name="id_status">
                                        <option value="" selected disabled>-- Pilih Status --</option>
                                        <?php
                                        foreach ($status as $d) : ?>
                                            <option value=<?= $d->id ?>> <?= $d->team ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
