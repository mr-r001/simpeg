                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('admin/jabatan/store') ?>" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name" tabindex="1" placeholder="Masukkan nama jabatan" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="gaji" type="number" name="gaji" tabindex="1" class="form-control currency" required>
                                        <div class="invalid-feedback">
