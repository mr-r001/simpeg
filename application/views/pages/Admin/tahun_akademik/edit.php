                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($tahun_akademik as $data) : ?>
                                <form method="post" class="needs-validation" action="<?php echo site_url('admin/tahun_akademik/update') ?>" novalidate="">
                                    <input type="hidden" name="id" value="<?= $data->id ?>">
                                    <div class="form-group">
                                        <label for="code">Kode Tahun Akademik <sup class="text-danger">*</sup></label>
                                        <input id="code" type="text" class="form-control" name="code" tabindex="1" value="<?= $data->kode_TA ?>" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="number" class="form-control" name="name" tabindex="1" value="<?= $data->tahun_akademik ?>" required>
                                        <div class="invalid-feedback">
