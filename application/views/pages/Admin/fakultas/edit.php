                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($fakultas as $data) : ?>
                                <form method="post" class="needs-validation" action="<?php echo site_url('admin/fakultas/update') ?>" novalidate="">
                                    <input type="hidden" name="id" value="<?= $data->id ?>">
                                    <div class="form-group">
                                        <label for="code">Kode Fakultas <sup class="text-danger">*</sup></label>
                                        <input id="code" type="text" class="form-control" name="code" tabindex="1" value="<?= $data->code ?>" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control" name="name" tabindex="1" value="<?= $data->name ?>" required>
                                        <div class="invalid-feedback">
