            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('admin/golongan/store') ?>" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name" tabindex="1" placeholder="Masukkan nama golongan" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="golongan" type="number" name="golongan" tabindex="1" class="form-control currency" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="pasutri" type="text" name="pasutri" tabindex="1" class="form-control currency" required>
                                        <div class="invalid-feedback">
                                            Please fill in nominal
                                        </div>
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="anak" type="text" name="anak" tabindex="1" class="form-control currency" required>
                                        <div class="invalid-feedback">
                                            Please fill in nominal
                                        </div>
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="jabatan" type="number" name="jabatan" tabindex="1" class="form-control currency" required>
                                        <div class="invalid-feedback">
                                            Please fill in nominal
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="makan" type="number" name="makan" tabindex="1" class="form-control currency" required>
                                        <div class="invalid-feedback">
                                            Please fill in nominal
                                        </div>
                                    </div>
