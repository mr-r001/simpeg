                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($kepangkatan as $data) : ?>
                                <?= form_open_multipart('pegawai/kepangkatan/update'); ?>
                                ...
                                <div class="form-group">
                                    <label>Kategori Tendik<sup class="text-danger">*</sup></label>
                                    <select class="form-control selectric" id="id_kategori" name="id_kategori">
                                        <option value="" selected disabled>-- Pilih Kategori Tendik --</option>
                                        <?php
