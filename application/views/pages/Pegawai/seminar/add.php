            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('pegawai/pelatihan/seminar/store') ?>" novalidate="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="judul">Judul Seminar<sup class="text-danger">*</sup></label>
                                    <input id="judul" type="text" class="form-control" name="judul" tabindex="1" placeholder="Masukkan Judul Seminar" required>
                                    <div class="invalid-feedback">
                                        Masukkan Judul Seminar terlebih dahulu
                                    </div>
                                </div>
                                <div class="form-group">
