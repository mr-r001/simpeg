                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach ($personal as $data) : ?>
                                <?= form_open_multipart('pegawai/personal/update'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" id="id_pegawai" name="id_pegawai">
                                        <option value="" selected disabled>-- Pilih Status Pegawai --</option>
                                        <?php
                                        foreach ($status as $d) : ?>
                                            <option <?php if ($data->id_pegawai == $d->id) : echo 'selected'; ?><?php endif; ?> value=<?= $d->id ?>> <?= $d->status_pegawai ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Kategori Tendik / Pegawai<sup class="text-danger">*</sup></label>
                                    <select class="form-control selectric" id="id_kategori" name="id_kategori">
                                        <option value="" selected disabled>-- Pilih Kategori Tendik / Pegawai --</option>
                                        <?php
                                        foreach ($sesuai as $d) : ?>
                                            <option <?php if ($data->id_kategori == $d->id) : echo 'selected'; ?><?php endif; ?> value=<?= $d->id ?>> <?= $d->name ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
