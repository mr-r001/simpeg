        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="<?php echo site_url('operator/report-pengabdian/download') ?>" novalidate="">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" id="filter" name="filter">
                                        ...
                                        <option value="1">Kegiatan Pengabdian</option>
                                        <option value="2">Pemateri</option>
                                    </select>
                                </div>
                                <div class="form-group">
